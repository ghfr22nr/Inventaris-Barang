...
<body class="p-3">
  ...
  <div class="container-fluid">
        ...
        <?php while ($row = $result->fetch_assoc()) : ?>
          <tr>
            ...
            <td>
              ...
              <a href="hapus.php?id=<?= $row['id_barang'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin hapus?')">Hapus</a>
            </td>
          </tr>
        <?php endwhile; ?>
      </tbody>
    ...
    <nav>
      ...
      <a href="../export/export_excel.php" class="btn btn-outline-success">Export Excel</a>
      <a href="../export/export_pdf.php" class="btn btn-outline-danger">Export PDF</a>
    </nav>
  </div>
  <sxcript
